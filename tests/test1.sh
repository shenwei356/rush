...
assert_no_stderr
assert_equal $(cat $STDOUT_FILE | sort -k1,1n | paste -sd" " | sed 's/ //g') '12345678910'
...
assert_no_stderr
assert_equal $(cat $STDOUT_FILE | sort -k1,1n | paste -sd" " | sed 's/ //g') '13579'
